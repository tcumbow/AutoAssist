...
local function BigLogicRoutine()
	...
	-- Environment Interaction (Looting, Stealing, Sprinting)
		...
		elseif Config.Disarm and AvailableReticleInteraction=="Disarm" then
			SetPixel(DoInteract)
		elseif Config.Loot and (AvailableReticleInteraction=="Destroy" or AvailableReticleInteraction=="Cut" or AvailableReticleInteraction=="Mine" or AvailableReticleInteraction=="Collect" or AvailableReticleInteraction=="Loot" or (AvailableReticleInteraction=="Take" and not (AvailableReticleTarget=="Spoiled Food" or AvailableReticleTarget=="Greatsword" or AvailableReticleTarget=="Sword" or AvailableReticleTarget=="Axe" or AvailableReticleTarget=="Bow" or AvailableReticleTarget=="Shield" or AvailableReticleTarget=="Staff" or AvailableReticleTarget=="Sabatons" or AvailableReticleTarget=="Dagger" or AvailableReticleTarget=="Cuirass" or AvailableReticleTarget=="Pauldron" or AvailableReticleTarget=="Helm" or AvailableReticleTarget=="Gauntlets" or AvailableReticleTarget=="Guards" or AvailableReticleTarget=="Boots" or AvailableReticleTarget=="Shoes")) or (AvailableReticleInteraction=="Use" and (AvailableReticleTarget=="Chest" or AvailableReticleTarget=="Treasure Chest" or AvailableReticleTarget=="Giant Clam"))) then
			SetPixel(DoInteract)
